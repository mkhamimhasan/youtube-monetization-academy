...
const LOGOS = [
  'MrBeast Labs', 'TechCreator Co.', 'Studio Nova', 'Apex Media',
  'Creator HQ', 'Neon Studios', 'Viral Works', 'Growth Guild',
  'Pixel Agency', 'Stream Kings', 'Revenue Rush', 'View Masters',
];
          ...
          {doubled.map((name, i) => (
            ...
            >
              <span
                ...
                style={{ background: i % 5 === 0 ? '#0066ff' : i % 5 === 1 ? '#00d4ff' : i % 5 === 2 ? '#7c3aed' : i % 5 === 3 ? '#34d399' : '#fbbf24' }}
              />
